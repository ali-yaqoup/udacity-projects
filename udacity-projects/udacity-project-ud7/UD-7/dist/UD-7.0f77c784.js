...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    setupModals();
    setupForms();
    (0, _utilityRenderFunctionsJs.renderCardSets)(cardSetsContainer, cardSets);
});
// Navigation setup
...
function setupForms() {
    ...
    createSetForm.addEventListener('submit', (e)=>{
        ...
        if (!setName) {
            (0, _utilityRenderFunctionsJs.showError)('create-set-error', 'Set name cannot be empty');
            return;
        }
        const newSet = {
            name: setName,
        ...
        (0, _utilityRenderFunctionsJs.renderCardSets)(cardSetsContainer, cardSets);
        createSetForm.reset();
        (0, _utilityRenderFunctionsJs.hideModal)('create-set-modal');
        showPage('card-sets');
    });
    // Add Card form
    addCardForm.addEventListener('submit', (e)=>{
        ...
        if (!front || !back) {
            (0, _utilityRenderFunctionsJs.showError)('add-card-error', 'Both card front and back cannot be empty');
            return;
        }
        if (currentCardSet) {
        ...
        addCardForm.reset();
        (0, _utilityRenderFunctionsJs.hideModal)('add-card-modal');
    });
    // Create Set button
    createSetBtn.addEventListener('click', ()=>{
        (0, _utilityRenderFunctionsJs.showModal)('create-set-modal');
    });
}
// Make functions globally accessible for HTML event handlers
window.showAddCardModal = function(cardSet) {
    currentCardSet = cardSet;
    (0, _utilityRenderFunctionsJs.showModal)('add-card-modal');
};
window.showModal = (0, _utilityRenderFunctionsJs.showModal);
window.hideModal = (0, _utilityRenderFunctionsJs.hideModal);

},{"./Shuffle.js":"ifKl7","./utilityRenderFunctions.js":"guzyD"}],"ifKl7":[function(require,module,exports,__globalThis) {
// Shuffle function for card arrays
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "shuffle", ()=>shuffle);
// Function to check if array is properly shuffled
parcelHelpers.export(exports, "isShuffled", ()=>isShuffled);
// Function to calculate shuffle quality (used for testing shuffle effectiveness)
parcelHelpers.export(exports, "calculateShuffleQuality", ()=>calculateShuffleQuality);
...
parcelHelpers.export(exports, "renderCardSets", ()=>renderCardSets);
...
parcelHelpers.export(exports, "shuffleAndRender", ()=>shuffleAndRender);
var _shuffleJs = require("./Shuffle.js");
function renderCardSets(container, cardSets) {
    container.innerHTML = '';
    cardSets.forEach((cardSet, index)=>{
        ...
        shuffleBtn.addEventListener('click', ()=>{
            cardSet.cards = (0, _shuffleJs.shuffle)(cardSet.cards);
        ...
        addCardBtn.addEventListener('click', ()=>{
            ...
            if (typeof window.showAddCardModal === 'function') window.showAddCardModal(cardSet);
        });
...
function shuffleAndRender(cardSet, container) {
    const shuffledCards = (0, _shuffleJs.shuffle)(cardSet.cards);
    cardSet.cards = shuffledCards;
    renderCards(container, shuffledCards);
}

},{"./Shuffle.js":"ifKl7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3HE9S","2R06K"], "2R06K", "parcelRequiree0f8", {})

//# sourceMappingURL=UD-7.0f77c784.js.map
